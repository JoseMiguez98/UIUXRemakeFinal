            ...
            <div className="cards-slider">
                ...
                <div className="swiper-button-next-wrapper">
                    <button className="swiper-button-next" onClick={this.goNext}>
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50px" height="50px"  fill="#bbb" viewBox="0 0 612 612" enableBackground="new 0 0 612 612">
                            <g id="_x39__30_">
                                <g>
